    ...
    return (
        <header className="mb-8 border-b">
            <div className="flex items-center justify-between mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl">
                ...
                <Link href='/'>
                    <h1 className="text-2xl md:text-4xl font-bold">من
                        <span className="text-primary"> مقازم</span>  </h1>
                </Link>

                <nav className="hidden gap-12 lg:flex 2xl:mr-16">
                    {links.map((link, idx)=>(
                    <div key={idx}>
                        {pathname === link.href?(
